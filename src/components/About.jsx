        ...
        <div id='about' className='pt-36 max-sm:pt-0 max-sm:mt-16 max-sm:px-4'>
            ...
            <div className='flex justify-between mt-15 max-sm:flex-col gap-y-5 max-sm:mt-8'>
                <div className='border px-20 py-5 rounded-[50px] border-[#E4B8BF30] text-center max-sm:rounded-4xl'>
                    <p className='text-7xl font-bold bg-gradient-to-r from-[#bcbad3] to-[#E4B8BF] bg-clip-text text-transparent max-sm:text-6xl'>37+</p>
                ...
                <div className='border px-20 py-5 rounded-[50px] border-[#E4B8BF30] text-center max-sm:rounded-4xl'>
                    <p className='text-7xl font-bold bg-gradient-to-r from-[#bcbad3] to-[#E4B8BF] bg-clip-text text-transparent max-sm:text-6xl'>2+</p>
                ...
                <div className='border px-20 py-5 rounded-[50px] border-[#E4B8BF30] text-center max-sm:rounded-4xl'>
                    <p className='text-7xl font-bold bg-gradient-to-r from-[#bcbad3] to-[#E4B8BF] bg-clip-text text-transparent max-sm:text-6xl'>49+</p>
