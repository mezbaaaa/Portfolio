    ...
    return (
        <div id='home' className='mt-50 '>
            ...
            <div className='mt-6 flex items-center gap-8'>
                <a href="#portfolio"><button className='border py-3 px-6 rounded-3xl cursor-pointer border-gray-700 font-bold text-xl flex items-center gap-2'>My Works <LayoutDashboard /></button></a>
